...
export function useApplications() {
  ...
  return {
    ...
    minimizeApplication: (applicationName: string) =>
      dispatch(minimizeApplication(applicationName)),
    maximizeApplication: (applicationName: string) =>
      dispatch(maximizeApplication(applicationName)),
    restoreApplication: (applicationName: string) =>
      dispatch(restoreApplication(applicationName)),
  }
}
