export const abi = [
  ...
  {
    "inputs": [],
    "name": "minOkbToReceivePerSleepUnit",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
