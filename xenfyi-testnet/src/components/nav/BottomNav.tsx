...
export const BottomNav: NextPage = () => {
  ...
  const { userMint, userStake } = { userMint: undefined, userStake: undefined }; // DEPRECATED: useContext(XENContext);
  ...
  return (
    <div
      className={clsx("btm-nav lg:hidden bg-slate-900/90 backdrop-blur-xl border-t border-blue-500/20 text-slate-200", {
        "h-24 pb-6":
